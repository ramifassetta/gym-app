    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:!bg-blue-50 hover:!text-blue-600 focus:!bg-blue-50 focus:!text-blue-600"
        ),
        ...
        day_outside:
          "day-outside text-muted-foreground aria-selected:!bg-blue-50 aria-selected:!text-blue-600",
