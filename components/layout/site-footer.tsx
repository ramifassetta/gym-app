...
import { Dumbbell, Facebook, Instagram, Linkedin, Mail, Phone } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start space-x-2 mb-4 sm:mb-6">
              ...
              <span className="text-lg sm:text-xl font-bold">Optifit</span>
            </div>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li className="flex items-center justify-center sm:justify-start">
                ...
                <a href="mailto:info@optifit.com" className="text-gray-400 hover:text-primary transition-colors text-sm sm:text-base">
                  info@optifit.com
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 pb-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-xs sm:text-sm text-center sm:text-left">
              &copy; {new Date().getFullYear()} Optifit. Todos los derechos reservados.
            </p>
