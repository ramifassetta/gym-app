...
export default function DashboardHeader({ onMenuClick }: DashboardHeaderProps) {
  ...
  return (
    <motion.header 
      ...
      className="flex h-16 items-center justify-between border-b border-primary/10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-3 sm:px-6"
    >
